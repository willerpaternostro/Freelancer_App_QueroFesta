    ...
    <div >
        <q-list>
            <q-item>
                ...
                <q-item-label class="text-grey-9"   lines="2">Fralda Pampers Confort-sec Tamanho Rn+</q-item-label>
                </q-item-section>
                <q-item-section side >
            ...
            <q-item>
                ...
                <q-item-label class="text-grey-9"  lines="2">Telefone - webset- whatsapp</q-item-label>
                </q-item-section>
                <q-item-section side >
                    <q-icon size="15px" name="fas fa-pen" color="grey-9" />
                </q-item-section>
            ...
            <q-item>
                ...
                <q-item-label class="text-grey-9"  lines="2">facebook.com - instagram.com - youtube.com</q-item-label>
                </q-item-section>
                <q-item-section side >
                    <q-icon size="15px" name="fas fa-pen" color="grey-9" />
                </q-item-section>
            ...
            <q-item>
                <q-item-section>
                <q-item-label class="text-h6 text-grey-7">Forma de Entrega</q-item-label>
                <q-item-label class="text-grey-9"  lines="2">Mercado Envios | Pessoalmente</q-item-label>
                </q-item-section>
                <q-item-section side >
                    <q-icon size="15px" name="fas fa-pen" color="grey-9" />
                </q-item-section>
            ...
            <q-item>
                <q-item-section>
                <q-item-label class="text-h6 text-grey-7">Tipo de Anúncio</q-item-label>
                <q-item-label class="text-grey-9"  lines="2">Clássico - Você pagará R$11,16 quando vender</q-item-label>
                </q-item-section>
                <q-item-section side >
                    <q-icon size="15px" name="fas fa-pen" color="grey-9" />
                </q-item-section>
